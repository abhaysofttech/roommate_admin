...
import { NetworkStatusService, ConnectionStatus } from './_services';
import { LocalSharedService } from './_services/local-shared.service';
...
export class AppComponent {
  ...
  constructor(
    ...
    private _sharedService: LocalSharedService,
  ) {
    this.initializeApp();
  }
